...
public class CalcTest {
    ...
    @Test
    public void testeDivOk() throws Exception{
        int resultado = calc.divisaoInt(10, 5);
        assertEquals(2, resultado);
    }

    @Test
    public void testeDivOk2() throws Exception{
        float resultado = calc.divisao(20,10);
        assertEquals(2, resultado);
    }

    @Test
    public void testeMultOk() throws Exception{
        int resultado = calc.multiplicacao(6, 2);
        assertEquals(12, resultado);
    }

    @Test
    public void testeSubOk() throws Exception{
